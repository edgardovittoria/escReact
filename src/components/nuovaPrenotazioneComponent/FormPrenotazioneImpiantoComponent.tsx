...
export const FormPrenotazioneImpianto: React.FC = () => {
    ...
    function onOrarioSelezione(orarioSelezionato: OrarioPrenotazione){
        setValue("dataPrenotazione", orarioSelezionato.dataOraInizio.toLocaleDateString())
        setValue("oraInizio", orarioSelezionato.dataOraInizio.toLocaleTimeString())
        setValue("oraFine", orarioSelezionato.dataOraFine.toLocaleTimeString())
        let object = {
