...
import { RiepilogoSquadra } from '../profiloSquadraComponent/RiepilogoSquadraComponent';
import { TabNuovaPrenotazioneSquadraComponent } from '../tabComponent/TabNuovaPrenotazioneSquadraComponent';
...
export const NuovaPrenotazioneImpiantoSquadra: React.FC = () => {
    ...
    useEffect(() => {
        ...
        dispatch(avviaNuovaPrenotazione(sportivoAutenticato.sportivo.email, squadra.idSquadra, "IMPIANTO", "SQUADRA", sportivoAutenticato.jwt))
    }, [])
                ...
                <div className="container">
                    ...
                    <RiepilogoSquadra nome={squadra.nome}
                        ...
                        <div className="col-8">
                            ...
                            <TabNuovaPrenotazioneSquadraComponent/>
                        </div>
                    </div>
                </div>
            </section>
